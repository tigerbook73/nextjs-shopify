...
export type CustomerAddressCreateMutation = { customerAddressCreate?: CustomerTypes.Maybe<{ customerAddress?: CustomerTypes.Maybe<Pick<CustomerTypes.CustomerAddress, 'id'>>, userErrors: Array<Pick<CustomerTypes.UserErrorsCustomerAddressUserErrors, 'field' | 'message' | 'code'>> }> };
...
export type CustomerAddressUpdateMutation = { customerAddressUpdate?: CustomerTypes.Maybe<{ customerAddress?: CustomerTypes.Maybe<Pick<CustomerTypes.CustomerAddress, 'id'>>, userErrors: Array<Pick<CustomerTypes.UserErrorsCustomerAddressUserErrors, 'field' | 'message' | 'code'>> }> };
...
export type CustomerAddressDeleteMutation = { customerAddressDelete?: CustomerTypes.Maybe<(
...
export type GetCustomerQuery = { customer: (
    Pick<CustomerTypes.Customer, 'id' | 'firstName' | 'lastName' | 'displayName'>
    & { emailAddress?: CustomerTypes.Maybe<Pick<CustomerTypes.CustomerEmailAddress, 'emailAddress'>>, orders: { nodes: Array<Pick<CustomerTypes.Order, 'id'>>, pageInfo: Pick<CustomerTypes.PageInfo, 'hasNextPage'> }, addresses: { nodes: Array<Pick<CustomerTypes.CustomerAddress, 'id'>>, pageInfo: Pick<CustomerTypes.PageInfo, 'hasNextPage'> } }
  ) };
...
export type GetOrdersQuery = { customer: { orders: { nodes: Array<(
        Pick<CustomerTypes.Order, 'id' | 'name' | 'processedAt' | 'financialStatus' | 'fulfillmentStatus'>
        & { totalPrice: Pick<CustomerTypes.MoneyV2, 'amount' | 'currencyCode'>, lineItems: { nodes: Array<(
            Pick<CustomerTypes.LineItem, 'title' | 'variantTitle' | 'quantity'>
            & { image?: CustomerTypes.Maybe<Pick<CustomerTypes.Image, 'url' | 'altText'>>, price?: CustomerTypes.Maybe<Pick<CustomerTypes.MoneyV2, 'amount' | 'currencyCode'>> }
          )> } }
...
export type GetOrderDetailQuery = { order?: CustomerTypes.Maybe<(
    Pick<CustomerTypes.Order, 'id' | 'name' | 'processedAt' | 'financialStatus' | 'fulfillmentStatus'>
    & { totalPrice: Pick<CustomerTypes.MoneyV2, 'amount' | 'currencyCode'>, subtotalPrice?: CustomerTypes.Maybe<Pick<CustomerTypes.MoneyV2, 'amount' | 'currencyCode'>>, totalShippingPrice: Pick<CustomerTypes.MoneyV2, 'amount' | 'currencyCode'>, totalTax?: CustomerTypes.Maybe<Pick<CustomerTypes.MoneyV2, 'amount' | 'currencyCode'>>, shippingAddress?: CustomerTypes.Maybe<(
      Pick<CustomerTypes.CustomerAddress, 'firstName' | 'lastName' | 'address1' | 'address2' | 'city' | 'province' | 'zip' | 'country'>
