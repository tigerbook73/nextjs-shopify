...
export type GetCustomerQuery = { customer: (
    ...
    & { emailAddress?: CustomerTypes.Maybe<Pick<CustomerTypes.CustomerEmailAddress, 'emailAddress'>>, orders: { nodes: Array<Pick<CustomerTypes.Order, 'id'>>, pageInfo: Pick<CustomerTypes.PageInfo, 'hasNextPage'> } }
  ) };
