...
export type CartCreateMutation = { cartCreate?: StorefrontTypes.Maybe<{ cart?: StorefrontTypes.Maybe<(
      ...
      & { lines: { nodes: Array<(
          ...
          & { merchandise: (
            ...
            & { selectedOptions: Array<Pick<StorefrontTypes.SelectedOption, 'name' | 'value'>>, price: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>, product: (
              Pick<StorefrontTypes.Product, 'title' | 'handle'>
...
export type GetCollectionsQuery = { collections: { nodes: Array<(
      ...
      & { image?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText'>>, seo: Pick<StorefrontTypes.Seo, 'title' | 'description'> }
    )> } };
...
export type GetCollectionByHandleQuery = { collection?: StorefrontTypes.Maybe<(
    Pick<StorefrontTypes.Collection, 'id' | 'title' | 'handle' | 'description'>
    & { image?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText'>>, seo: Pick<StorefrontTypes.Seo, 'title' | 'description'>, products: { nodes: Array<(
        Pick<StorefrontTypes.Product, 'id' | 'title' | 'handle' | 'availableForSale'>
        & { priceRange: { minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, compareAtPriceRange: { minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount'> }, featuredImage?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText'>> }
...
export type GetProductByHandleQuery = { product?: StorefrontTypes.Maybe<(
    Pick<StorefrontTypes.Product, 'id' | 'title' | 'handle' | 'availableForSale' | 'description' | 'descriptionHtml'>
    & { priceRange: { minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, compareAtPriceRange: { minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount'> }, featuredImage?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText'>>, images: { nodes: Array<Pick<StorefrontTypes.Image, 'url' | 'altText'>> }, variants: { nodes: Array<(
